  ...
  <main class="py-5">
    ...
    <div class="container">
        ...
        <div class="text-center">
            ...
            <h3>STATION 2</h3>
            <iframe id="embed_player" frameborder="0" width="280" height="216" src="https://fliptop2.airtime.pro/embed/player?stream=auto"></iframe>
            <hr>
            ...
            <hr>
            <img src="{{ asset('images/radio/6_fri.jpg') }}">
            <img src="{{ asset('images/radio/7_sat.jpg') }}">
            <img src="{{ asset('images/radio/1_sun.jpg') }}">
            <img src="{{ asset('images/radio/2_mon.jpg') }}">
            <img src="{{ asset('images/radio/3_tue.jpg') }}">
            <img src="{{ asset('images/radio/4_wed.jpg') }}">
            <img src="{{ asset('images/radio/5_thurs.jpg') }}">
            <hr>
